...
export const MILO_AWARE_FIELDS = [
    ...
    },
    {
        ...
        type: "text",
        defaultForRoles: ["MLO", "BROKER"],
        description: "Numeric monthly rent. HS catalog declares type 'number'; the package " +
 ...
 */
export const COMPLIANCE_HOLD_KEYS = new Set([
    "scout_age_62_plus",
]);
/** True if `key` is registered but compliance-held (do NOT branch on it). */
export function isComplianceHold(key) {
